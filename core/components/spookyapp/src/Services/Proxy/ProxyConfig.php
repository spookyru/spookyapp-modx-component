 ...
 *
 * Архитектура прокси:
 * - Amsterdam nginx принимает запросы только с IP продакшен-сервера
...
final class ProxyConfig
{
     ...
     *
     * Соответствует location-блокам в конфиге nginx на Amsterdam-сервере.
     ...
     * Яндекс-запросы всегда идут напрямую: сервис работает в РФ
